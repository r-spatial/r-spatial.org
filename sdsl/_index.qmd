...
|15:30-17:00| [Discrete global grids](https://en.wikipedia.org/wiki/Discrete_global_grid); [datacubes](https://r-spatial.org/book/06-Cubes.html), pyramids, [geozarr](https://github.com/zarr-developers/geozarr-spec)  |
|           | |
...
|**Tue, Sep 19**|
|9:00-10:30 | Extracting attributes from polygons at point locations: [attribute-geometry relationship](https://r-spatial.org/book/05-Attributes.html#sec-agr),
[spatially extensive/intensive variables, area-weighted interpolation](https://r-spatial.org/book/05-Attributes.html#sec-area-weighted), OGR field domain and [merge & split rules](https://gdal.org/doxygen/classOGRFieldDomain.html) |
|10:30-11:00| Coffee/tea |
|11:00-12:30| Packaging (GDAL/GEOS/PROJ/ … upstream dependencies)|
|12:30-13:30| Lunch break |
|13:30-15:00| Educational resources, multi-language resources [1](https://r-spatial.org/python/), [2](https://geocompx.org/) and case studies [3](https://doi.org/10.1111/gean.12319);  Community: user vs. developer community, community management and building,  [retirement/evolution](https://github.com/r-spatial/evolution),  diversity and equity |
|15:00-15:30| Coffee/tea
|15:30-17:00| Statistical models: neighbourhood lists, spatial weights, covariance functions; future joint activities; closing |
| | |
