...
date: 18 July, 2016
layout: post
meta-json: {"layout":"post","categories":"r","date":"18 July, 2016","author":"Edzer Pebesma","comments":true,"title":"Simple features for R, part 2"}
...
relate to the geometry: are the constant (field), aggregated over the
geometry (lattice), or refer to individual entities (buildings, parcels
etc.)?
