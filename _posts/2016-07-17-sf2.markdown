...
by
    ...
    ##   widths                               geom
    ## 1    5.0 MULTILINESTRING((2 2, 3 3, 3 2 ...
    ## 2    4.5 MULTILINESTRING((5 5, 4 1, 1 2 ...

    summary(roads.sf)

    ##      widths                   geom  
    ##  Min.   :4.500   MULTILINESTRING:2  
...
The following works for me, with PostGIS installed:
    ...
    ##   zinc                      geom
    ## 1 1022 MULTIPOINT(181072 333611)
    ## 2 1141 MULTIPOINT(181025 333558)
    ## 3  640 MULTIPOINT(181165 333537)
    ## 4  257 MULTIPOINT(181298 333484)
    ## 5  269 MULTIPOINT(181307 333330)

    summary(s)

    ##       zinc                   geom    
    ##  Min.   : 113.0   MULTIPOINT   :155  
