...
Suppose you have the following geometry, consisting of three overlapping polygons:
...
and you are interested in the area where all circles overlap (green),
or where exactly two circles overlap (orange):
