...
can override the `NA` convenience to get standard-complient dimensions by
```{r}
...
6. `st_buffer(st_geometry(x), 0)` (but beware of the bowtie example above, where `st_buffer` removes one half). 
