...
The eigenvalues `m$values` reflect the noise fraction, $\sigma^2_n /
\sigma^2$, for the corresponding component. Reading the `Cumulative
Proportion`, we can see that the first component takes care of 90% of
the noise, the first two of 96% of the  noise. Importance is measured
in terms of noise fraction, which decreases with component number.
