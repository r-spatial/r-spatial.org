...
According to Green et al. (1988), the eigenvalues `m$values`
reflect the noise fraction, $\sigma^2_n / \sigma^2$ of the
corresponding component. How should we interpret a value larger
than one? Reading the `Cumulative Proportion`, it suggests that the
first component takes care of 90% of the noise, the first two of 96%
of the  noise. Importance is measured in terms of noise fraction,
which decreases with component number.
