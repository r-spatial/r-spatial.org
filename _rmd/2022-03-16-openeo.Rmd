...
**Summary**:
openEO is an open source community-based API for cloud-based
processing of Earth Observation data. This blog introduces the R
openeo client, and demonstrates a sample analysis using [openEO
Platform](https://openeo.cloud) for processing.
