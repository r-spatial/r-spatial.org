---
layout: post
title:  "Participant experience of the Spring School on “Statistical analysis of hyperspectral and high-dimensional remote-sensing data using R” at the Department of Geography (University of Jena), Germany, March 13-17, 2017"
...
The Spring School on “Statistical analysis of hyperspectral and high-dimensional remote-sensing data using R” was organized by the GIScience group lead by [Prof. Alexander Brenning](http://www.geographie.uni-jena.de/Brenning.html) and two researchers from his GIScience research group, [Patrick Schratz](https://pat-s.github.io/) and [Dr. Jannes Münchow](http://www.geographie.uni-jena.de/Muenchow.html).  
...
In this short blog-post I want to give you a quick overview of the many, many things we learned during this intense “spatial stats-and-R-week”.

<img src="../images/spring-school-jena1.jpg", width="100%" style="display: block; margin: auto;" />
...
<figure>
<img src="../images/spring-school-jena6.jpg", width="70%" height="40%" style="display: block; margin: auto;"  alt='missing'/>
<figcaption><center>*Lecture by Prof. A. Brenning on “Statistical and machine learning in remote sensing”, © H. Petschko*</center></figcaption>
</figure>

# Day 2

The second day was filled with hand-on R sessions. In a first session by Patrick Schratz we learned about his “must know” features of R, namely Rmarkdown, the apply-family and pipes.  
...
Afterwards we were introduced to the package [mapview](https://github.com/environmentalinformatics-marburg/mapview), an R package by Dr. Tim Appelhans. 
...
<img src="../images/spring-school-jena2.jpg", width="70%" height="40%" style="display: block; margin: auto;" />
<center>*Solving R-problems with Dr. Jannes Münchow, © H. Petschko*</center>
...
<img src="../images/spring-school-jena3.jpg", width="70%" height="40%" style="display: block; margin: auto;" />
<center>*Open session during the Day3 of the Spring School to discuss research projects of the participants, © H. Petschko*</center>
...
<img src="../images/spring-school-jena4.jpg", width="70%" height="40%" style="display: block; margin: auto;" />
<center>*Discussing sampling designs with Prof. A. Brenning, © H. Petschko*</center>

<img src="../images/spring-school-jena5.jpg", width="70%" height="40%" style="display: block; margin: auto;" />
<center>*Introduction to parallel processing in R with Patrick Schratz, © H. Petschko*</center>
...
<figure>
<img src="../images/spring-school-jena7.jpg", width="70%" height="40%" style="display: block; margin: auto;" />
<figcaption><center>*Tornado damage in the Thuringian Forest from September 2016 © P. Schratz*</center></figcaption>
</figure>

<br>

<figure>
<img src="../images/spring-school-jena8.jpg", width="70%" height="40%" style="display: block; margin: auto;" />
<figcaption><center>*Field trip to the Thuringian Forest, © X. Tagle*</center></figcaption>
</figure>